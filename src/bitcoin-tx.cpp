...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bridgecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bridgecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bridgecoin transaction") + "\n" +
              "  bridgecoin-tx [options] -create [commands]   " + _("Create hex-encoded bridgecoin transaction") + "\n" +
              "\n";
