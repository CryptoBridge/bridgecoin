...
void Shutdown()
{
    ...
    RenameThread("bridgecoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bridgecoin-project/bridgecoin>";
    const std::string URL_WEBSITE = "<https://bridgecoin.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("bridgecoin-loadblk");
    CImportingNow imp;
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("bridgecoin version %s\n", FormatFullVersion());
}
